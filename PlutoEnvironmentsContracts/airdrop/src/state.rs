...
pub fn read_config(storage: &Storage) -> StdResult<Config> {
...
pub fn read_latest_stage(storage: &Storage) -> StdResult<u8> {
...
pub fn read_claimed(storage: &Storage, user: &Addr, stage: u8) -> StdResult<bool> {
