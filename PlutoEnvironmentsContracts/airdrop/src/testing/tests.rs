...
use crate::msg::{
    ConfigResponse, HandleMsg, IsClaimedResponse, LatestStageResponse, MerkleRootResponse,
    QueryMsg,
};
...
fn proper_initialization() {
    ...
    let msg = InitMsg {
        ...
        pluto_token: HumanAddr("pluto0000".to_string()),
    };
    ...
    assert_eq!("pluto0000", config.pluto_token.as_str());
...
fn update_config() {
    ...
    let msg = InitMsg {
        ...
        pluto_token: HumanAddr::from("pluto0000"),
    };
...
fn claim() {
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: HumanAddr::from("pluto0000"),
            funds: vec![],
